...
CREATE TABLE `blog_article` (
  ...
  `content` text,
  `create_on` int(11) DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `blog_auth` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='账号管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `blog_auth` VALUES (1,'linksystem','linksystem');
...
-- Dump completed on 2018-12-18 20:42:33
